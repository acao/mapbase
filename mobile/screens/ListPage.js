...
import CreatePage from './CreateDataPoint';
    ...
    return (
      <View style={styles.container}>
        ...
        <ListView
          ...
          renderRow={post => <Post description={post.description} imageUrl={post.imageUrl} />}
        />
        <TouchableHighlight style={styles.createPostButtonContainer} onPress={this._createPost}>
